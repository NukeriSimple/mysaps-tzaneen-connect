...
A comprehensive crime reporting and case tracking system designed specifically for the Tzaneen community in Limpopo, South Africa.

## 🌟 Features

### Core Functionality
- **Case Reporting**: Report incidents with detailed descriptions, location, and evidence
- **Voice Reporting**: Speech-to-text functionality in English and Xitsonga for users with limited literacy
...
- **Bilingual Support**: Full interface in English, Xitsonga, Sepedi, and TshiVenda
...
- **Safety Tips Library**: Crime prevention information in multiple languages
